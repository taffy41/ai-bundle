        ...
        ->children()
                                ...
                                ->validate()
                                    ->always(static function (array $values) {
                                        return array_map(static function ($v) {
                                            ...
                                            if (null === $case) {
                                                throw new \InvalidArgumentException(\sprintf('The value "%s" is not a valid capability. Permissible values: %s', $v, implode(', ', array_map(static fn (Capability $c) => $c->value, Capability::cases()))));
                                            }
            ...
            ->arrayNode('chat')
                ...
                ->arrayPrototype()
                    ->children()
                        ->scalarNode('agent')->cannotBeEmpty()->end()
                        ->scalarNode('message_store')->cannotBeEmpty()->end()
                    ->end()
                ->end()
            ->end()
